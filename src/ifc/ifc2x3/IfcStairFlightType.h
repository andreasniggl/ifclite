#ifndef IFC2X3_IFCSTAIRFLIGHTTYPE_H_INCLUDED
#define IFC2X3_IFCSTAIRFLIGHTTYPE_H_INCLUDED
...
namespace ifc2x3
{
   ...
   public:
      ...
      IfcStairFlightType(const IfcGloballyUniqueId& _GlobalId, IfcOwnerHistory* _OwnerHistory, const IfcStairFlightTypeEnum& _PredefinedType)
         : IfcBuildingElementType(_GlobalId, _OwnerHistory), PredefinedType(_PredefinedType) {}

      virtual std::string name() const { return "IfcStairFlightType"; }

      boost::optional<IfcStairFlightTypeEnum> PredefinedType; // required parameter
   ...
   protected:
      virtual void serialize(ifc::StepWriter& w) const
      {
         ...
         w.writeAttributeValueEnumeration(IfcStairFlightTypeEnumStringMap, PredefinedType);
         w.endEntity();
      }
