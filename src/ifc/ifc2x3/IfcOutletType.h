#ifndef IFC2X3_IFCOUTLETTYPE_H_INCLUDED
#define IFC2X3_IFCOUTLETTYPE_H_INCLUDED
...
namespace ifc2x3
{
   ...
   public:
      ...
      IfcOutletType(const IfcGloballyUniqueId& _GlobalId, IfcOwnerHistory* _OwnerHistory, const IfcOutletTypeEnum& _PredefinedType)
         : IfcFlowTerminalType(_GlobalId, _OwnerHistory), PredefinedType(_PredefinedType) {}

      virtual std::string name() const { return "IfcOutletType"; }
   ...
   protected:
      virtual void serialize(ifc::StepWriter& w) const
      {
         ...
         w.writeAttributeValueEnumeration(IfcOutletTypeEnumStringMap, PredefinedType);
         w.endEntity();
      }
