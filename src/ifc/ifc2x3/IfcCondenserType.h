...
namespace ifc2x3
{
   ...
   public:
      ...
      explicit IfcCondenserType() = default;

      explicit IfcCondenserType(const IfcGloballyUniqueId& _GlobalId, IfcOwnerHistory* _OwnerHistory, const IfcCondenserTypeEnum& _PredefinedType)
         : IfcEnergyConversionDeviceType(_GlobalId, _OwnerHistory), PredefinedType(_PredefinedType) {}

      virtual std::string className() const { return "IfcCondenserType"; }
