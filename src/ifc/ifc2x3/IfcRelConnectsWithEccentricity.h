...
namespace ifc2x3
{
   ...
   public:
      ...
      explicit IfcRelConnectsWithEccentricity(const IfcGloballyUniqueId& _GlobalId, IfcOwnerHistory* _OwnerHistory, IfcStructuralMember* _RelatingStructuralMember, IfcStructuralConnection* _RelatedStructuralConnection, IfcConnectionGeometry* _ConnectionConstraint)
