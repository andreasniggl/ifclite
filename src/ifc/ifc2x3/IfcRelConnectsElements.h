...
namespace ifc2x3
{
   ...
   public:
      ...
      explicit IfcRelConnectsElements(const IfcGloballyUniqueId& _GlobalId, IfcOwnerHistory* _OwnerHistory, IfcElement* _RelatingElement, IfcElement* _RelatedElement)
