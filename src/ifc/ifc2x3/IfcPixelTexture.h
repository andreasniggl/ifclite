...
namespace ifc2x3
{
   ...
   public:
      ...
      explicit IfcPixelTexture(const bool& _RepeatS, const bool& _RepeatT, const IfcSurfaceTextureEnum& _TextureType, const IfcInteger& _Width, const IfcInteger& _Height, const IfcInteger& _ColourComponents, const std::vector<int>& _Pixel)
      ...
      std::vector<int> Pixel; // required parameter
