#ifndef IFC2X3_IFCCREWRESOURCE_H_INCLUDED
#define IFC2X3_IFCCREWRESOURCE_H_INCLUDED
...
namespace ifc2x3
{
   ...
   public:
      ...
      IfcCrewResource(const IfcGloballyUniqueId& _GlobalId, IfcOwnerHistory* _OwnerHistory)
         : IfcConstructionResource(_GlobalId, _OwnerHistory) {}

      virtual std::string name() const { return "IfcCrewResource"; }
