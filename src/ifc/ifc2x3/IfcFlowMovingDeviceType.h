#ifndef IFC2X3_IFCFLOWMOVINGDEVICETYPE_H_INCLUDED
#define IFC2X3_IFCFLOWMOVINGDEVICETYPE_H_INCLUDED
...
namespace ifc2x3
{
   ...
   {
   public:
      virtual ~IfcFlowMovingDeviceType(){}

      IfcFlowMovingDeviceType() = default;

      IfcFlowMovingDeviceType(const IfcGloballyUniqueId& _GlobalId, IfcOwnerHistory* _OwnerHistory)
         : IfcDistributionFlowElementType(_GlobalId, _OwnerHistory) {}

      virtual std::string name() const { return "IfcFlowMovingDeviceType"; }
