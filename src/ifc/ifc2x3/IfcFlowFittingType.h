#ifndef IFC2X3_IFCFLOWFITTINGTYPE_H_INCLUDED
#define IFC2X3_IFCFLOWFITTINGTYPE_H_INCLUDED
...
namespace ifc2x3
{
   ...
   public:
      ...
      IfcFlowFittingType(const IfcGloballyUniqueId& _GlobalId, IfcOwnerHistory* _OwnerHistory)
         : IfcDistributionFlowElementType(_GlobalId, _OwnerHistory) {}

      virtual std::string name() const { return "IfcFlowFittingType"; }
