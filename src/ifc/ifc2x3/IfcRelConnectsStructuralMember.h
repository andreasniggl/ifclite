...
namespace ifc2x3
{
   ...
   public:
      ...
      explicit IfcRelConnectsStructuralMember(const IfcGloballyUniqueId& _GlobalId, IfcOwnerHistory* _OwnerHistory, IfcStructuralMember* _RelatingStructuralMember, IfcStructuralConnection* _RelatedStructuralConnection)
