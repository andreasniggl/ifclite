...
namespace ifc2x3
{
   ...
   public:
      ...
      explicit IfcWorkSchedule(const IfcGloballyUniqueId& _GlobalId, IfcOwnerHistory* _OwnerHistory, const IfcIdentifier& _Identifier, const IfcDateTimeSelect& _CreationDate, const IfcDateTimeSelect& _StartTime)
