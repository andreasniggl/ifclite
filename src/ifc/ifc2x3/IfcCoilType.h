#ifndef IFC2X3_IFCCOILTYPE_H_INCLUDED
#define IFC2X3_IFCCOILTYPE_H_INCLUDED
...
namespace ifc2x3
{
   ...
   public:
      ...
      IfcCoilType(const IfcGloballyUniqueId& _GlobalId, IfcOwnerHistory* _OwnerHistory, const IfcCoilTypeEnum& _PredefinedType)
         : IfcEnergyConversionDeviceType(_GlobalId, _OwnerHistory), PredefinedType(_PredefinedType) {}

      virtual std::string name() const { return "IfcCoilType"; }
   ...
   protected:
      virtual void serialize(ifc::StepWriter& w) const
      {
         ...
         w.writeAttributeValueEnumeration(IfcCoilTypeEnumStringMap, PredefinedType);
         w.endEntity();
      }
