#ifndef IFC2X3_IFCRELASSOCIATESLIBRARY_H_INCLUDED
#define IFC2X3_IFCRELASSOCIATESLIBRARY_H_INCLUDED
...
namespace ifc2x3
{
   ...
   public:
      ...
      IfcRelAssociatesLibrary(const IfcGloballyUniqueId& _GlobalId, IfcOwnerHistory* _OwnerHistory, const std::vector<IfcRoot*>& _RelatedObjects, const IfcLibrarySelect& _RelatingLibrary)
         : IfcRelAssociates(_GlobalId, _OwnerHistory, _RelatedObjects), RelatingLibrary(_RelatingLibrary) {}

      virtual std::string name() const { return "IfcRelAssociatesLibrary"; }
