#ifndef IFC2X3_IFCSHAPEREPRESENTATION_H_INCLUDED
#define IFC2X3_IFCSHAPEREPRESENTATION_H_INCLUDED
...
namespace ifc2x3
{
   ...
   public:
      ...
      IfcShapeRepresentation(IfcRepresentationContext* _ContextOfItems, const std::vector<IfcRepresentationItem*>& _Items)
         : IfcShapeModel(_ContextOfItems, _Items) {}

      virtual std::string name() const { return "IfcShapeRepresentation"; }
