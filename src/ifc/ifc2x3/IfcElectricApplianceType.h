...
namespace ifc2x3
{
   ...
   public:
      ...
      explicit IfcElectricApplianceType(const IfcGloballyUniqueId& _GlobalId, IfcOwnerHistory* _OwnerHistory, const IfcElectricApplianceTypeEnum& _PredefinedType)
