...
namespace ifc2x3
{
   ...
   public:
      ...
      explicit IfcIrregularTimeSeries(const IfcLabel& _Name, const IfcDateTimeSelect& _StartTime, const IfcDateTimeSelect& _EndTime, const IfcTimeSeriesDataTypeEnum& _TimeSeriesDataType, const IfcDataOriginEnum& _DataOrigin, const std::vector<IfcIrregularTimeSeriesValue*>& _Values)
