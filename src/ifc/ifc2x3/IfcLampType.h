#ifndef IFC2X3_IFCLAMPTYPE_H_INCLUDED
#define IFC2X3_IFCLAMPTYPE_H_INCLUDED
...
namespace ifc2x3
{
   ...
   public:
      ...
      IfcLampType(const IfcGloballyUniqueId& _GlobalId, IfcOwnerHistory* _OwnerHistory, const IfcLampTypeEnum& _PredefinedType)
         : IfcFlowTerminalType(_GlobalId, _OwnerHistory), PredefinedType(_PredefinedType) {}

      virtual std::string name() const { return "IfcLampType"; }
   ...
   protected:
      virtual void serialize(ifc::StepWriter& w) const
      {
         ...
         w.writeAttributeValueEnumeration(IfcLampTypeEnumStringMap, PredefinedType);
         w.endEntity();
      }
