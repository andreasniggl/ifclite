#ifndef IFC2X3_IFCDISTRIBUTIONCHAMBERELEMENT_H_INCLUDED
#define IFC2X3_IFCDISTRIBUTIONCHAMBERELEMENT_H_INCLUDED
...
namespace ifc2x3
{
   ...
   public:
      ...
      IfcDistributionChamberElement(const IfcGloballyUniqueId& _GlobalId, IfcOwnerHistory* _OwnerHistory)
         : IfcDistributionFlowElement(_GlobalId, _OwnerHistory) {}

      virtual std::string name() const { return "IfcDistributionChamberElement"; }
