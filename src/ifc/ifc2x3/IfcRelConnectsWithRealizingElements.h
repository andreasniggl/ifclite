...
namespace ifc2x3
{
   ...
   public:
      ...
      explicit IfcRelConnectsWithRealizingElements(const IfcGloballyUniqueId& _GlobalId, IfcOwnerHistory* _OwnerHistory, IfcElement* _RelatingElement, IfcElement* _RelatedElement, const std::vector<IfcElement*>& _RealizingElements)
