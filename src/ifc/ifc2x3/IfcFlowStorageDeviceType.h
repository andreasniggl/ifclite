#ifndef IFC2X3_IFCFLOWSTORAGEDEVICETYPE_H_INCLUDED
#define IFC2X3_IFCFLOWSTORAGEDEVICETYPE_H_INCLUDED
...
namespace ifc2x3
{
   ...
   public:
      ...
      IfcFlowStorageDeviceType(const IfcGloballyUniqueId& _GlobalId, IfcOwnerHistory* _OwnerHistory)
         : IfcDistributionFlowElementType(_GlobalId, _OwnerHistory) {}

      virtual std::string name() const { return "IfcFlowStorageDeviceType"; }
