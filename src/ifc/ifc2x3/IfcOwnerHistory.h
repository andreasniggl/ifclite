...
namespace ifc2x3
{
   ...
   public:
      ...
      explicit IfcOwnerHistory(IfcPersonAndOrganization* _OwningUser, IfcApplication* _OwningApplication, const IfcChangeActionEnum& _ChangeAction, const IfcTimeStamp& _CreationDate)
