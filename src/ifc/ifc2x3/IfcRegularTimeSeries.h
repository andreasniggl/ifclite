...
namespace ifc2x3
{
   ...
   public:
      ...
      explicit IfcRegularTimeSeries(const IfcLabel& _Name, const IfcDateTimeSelect& _StartTime, const IfcDateTimeSelect& _EndTime, const IfcTimeSeriesDataTypeEnum& _TimeSeriesDataType, const IfcDataOriginEnum& _DataOrigin, const IfcTimeMeasure& _TimeStep, const std::vector<IfcTimeSeriesValue*>& _Values)
