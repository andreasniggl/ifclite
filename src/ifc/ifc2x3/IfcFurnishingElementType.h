#ifndef IFC2X3_IFCFURNISHINGELEMENTTYPE_H_INCLUDED
#define IFC2X3_IFCFURNISHINGELEMENTTYPE_H_INCLUDED
...
namespace ifc2x3
{
   ...
   {
   public:
      virtual ~IfcFurnishingElementType(){}

      IfcFurnishingElementType() = default;

      IfcFurnishingElementType(const IfcGloballyUniqueId& _GlobalId, IfcOwnerHistory* _OwnerHistory)
         : IfcElementType(_GlobalId, _OwnerHistory) {}

      virtual std::string name() const { return "IfcFurnishingElementType"; }
