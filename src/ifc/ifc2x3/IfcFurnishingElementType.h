...
namespace ifc2x3
{
   ...
   public:
      ...
      explicit IfcFurnishingElementType() = default;

      explicit IfcFurnishingElementType(const IfcGloballyUniqueId& _GlobalId, IfcOwnerHistory* _OwnerHistory)
         : IfcElementType(_GlobalId, _OwnerHistory) {}

      virtual std::string className() const { return "IfcFurnishingElementType"; }
