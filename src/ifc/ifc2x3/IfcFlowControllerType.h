#ifndef IFC2X3_IFCFLOWCONTROLLERTYPE_H_INCLUDED
#define IFC2X3_IFCFLOWCONTROLLERTYPE_H_INCLUDED
...
namespace ifc2x3
{
   ...
   {
   public:
      virtual ~IfcFlowControllerType(){}

      IfcFlowControllerType() = default;

      IfcFlowControllerType(const IfcGloballyUniqueId& _GlobalId, IfcOwnerHistory* _OwnerHistory)
         : IfcDistributionFlowElementType(_GlobalId, _OwnerHistory) {}

      virtual std::string name() const { return "IfcFlowControllerType"; }
