#ifndef IFC2X3_IFCCHILLERTYPE_H_INCLUDED
#define IFC2X3_IFCCHILLERTYPE_H_INCLUDED
...
namespace ifc2x3
{
   ...
   public:
      ...
      IfcChillerType(const IfcGloballyUniqueId& _GlobalId, IfcOwnerHistory* _OwnerHistory, const IfcChillerTypeEnum& _PredefinedType)
         : IfcEnergyConversionDeviceType(_GlobalId, _OwnerHistory), PredefinedType(_PredefinedType) {}

      virtual std::string name() const { return "IfcChillerType"; }
   ...
   protected:
      virtual void serialize(ifc::StepWriter& w) const
      {
         ...
         w.writeAttributeValueEnumeration(IfcChillerTypeEnumStringMap, PredefinedType);
         w.endEntity();
      }
