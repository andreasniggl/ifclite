#ifndef IFC2X3_IFCSTRUCTURALPOINTCONNECTION_H_INCLUDED
#define IFC2X3_IFCSTRUCTURALPOINTCONNECTION_H_INCLUDED
...
namespace ifc2x3
{
   ...
   public:
      ...
      IfcStructuralPointConnection(const IfcGloballyUniqueId& _GlobalId, IfcOwnerHistory* _OwnerHistory)
         : IfcStructuralConnection(_GlobalId, _OwnerHistory) {}

      virtual std::string name() const { return "IfcStructuralPointConnection"; }
