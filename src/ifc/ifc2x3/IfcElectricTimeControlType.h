...
namespace ifc2x3
{
   ...
   public:
      ...
      explicit IfcElectricTimeControlType(const IfcGloballyUniqueId& _GlobalId, IfcOwnerHistory* _OwnerHistory, const IfcElectricTimeControlTypeEnum& _PredefinedType)
