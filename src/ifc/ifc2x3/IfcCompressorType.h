#ifndef IFC2X3_IFCCOMPRESSORTYPE_H_INCLUDED
#define IFC2X3_IFCCOMPRESSORTYPE_H_INCLUDED
...
namespace ifc2x3
{
   ...
   public:
      ...
      IfcCompressorType(const IfcGloballyUniqueId& _GlobalId, IfcOwnerHistory* _OwnerHistory, const IfcCompressorTypeEnum& _PredefinedType)
         : IfcFlowMovingDeviceType(_GlobalId, _OwnerHistory), PredefinedType(_PredefinedType) {}

      virtual std::string name() const { return "IfcCompressorType"; }
   ...
   protected:
      virtual void serialize(ifc::StepWriter& w) const
      {
         ...
         w.writeAttributeValueEnumeration(IfcCompressorTypeEnumStringMap, PredefinedType);
         w.endEntity();
      }
