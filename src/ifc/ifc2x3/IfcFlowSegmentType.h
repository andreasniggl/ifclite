#ifndef IFC2X3_IFCFLOWSEGMENTTYPE_H_INCLUDED
#define IFC2X3_IFCFLOWSEGMENTTYPE_H_INCLUDED
...
namespace ifc2x3
{
   ...
   public:
      ...
      IfcFlowSegmentType(const IfcGloballyUniqueId& _GlobalId, IfcOwnerHistory* _OwnerHistory)
         : IfcDistributionFlowElementType(_GlobalId, _OwnerHistory) {}

      virtual std::string name() const { return "IfcFlowSegmentType"; }
