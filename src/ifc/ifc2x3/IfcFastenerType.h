#ifndef IFC2X3_IFCFASTENERTYPE_H_INCLUDED
#define IFC2X3_IFCFASTENERTYPE_H_INCLUDED
...
namespace ifc2x3
{
   ...
   public:
      ...
      IfcFastenerType(const IfcGloballyUniqueId& _GlobalId, IfcOwnerHistory* _OwnerHistory)
         : IfcElementComponentType(_GlobalId, _OwnerHistory) {}

      virtual std::string name() const { return "IfcFastenerType"; }
