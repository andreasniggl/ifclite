#ifndef IFC2X3_IFCSTACKTERMINALTYPE_H_INCLUDED
#define IFC2X3_IFCSTACKTERMINALTYPE_H_INCLUDED
...
namespace ifc2x3
{
   ...
   public:
      ...
      IfcStackTerminalType(const IfcGloballyUniqueId& _GlobalId, IfcOwnerHistory* _OwnerHistory, const IfcStackTerminalTypeEnum& _PredefinedType)
         : IfcFlowTerminalType(_GlobalId, _OwnerHistory), PredefinedType(_PredefinedType) {}

      virtual std::string name() const { return "IfcStackTerminalType"; }
   ...
   protected:
      virtual void serialize(ifc::StepWriter& w) const
      {
         ...
         w.writeAttributeValueEnumeration(IfcStackTerminalTypeEnumStringMap, PredefinedType);
         w.endEntity();
      }
