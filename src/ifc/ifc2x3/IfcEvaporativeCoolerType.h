#ifndef IFC2X3_IFCEVAPORATIVECOOLERTYPE_H_INCLUDED
#define IFC2X3_IFCEVAPORATIVECOOLERTYPE_H_INCLUDED
...
namespace ifc2x3
{
   ...
   public:
      ...
      IfcEvaporativeCoolerType(const IfcGloballyUniqueId& _GlobalId, IfcOwnerHistory* _OwnerHistory, const IfcEvaporativeCoolerTypeEnum& _PredefinedType)
         : IfcEnergyConversionDeviceType(_GlobalId, _OwnerHistory), PredefinedType(_PredefinedType) {}

      virtual std::string name() const { return "IfcEvaporativeCoolerType"; }
   ...
   protected:
      virtual void serialize(ifc::StepWriter& w) const
      {
         ...
         w.writeAttributeValueEnumeration(IfcEvaporativeCoolerTypeEnumStringMap, PredefinedType);
         w.endEntity();
      }
