#ifndef IFC2X3_IFCCURTAINWALLTYPE_H_INCLUDED
#define IFC2X3_IFCCURTAINWALLTYPE_H_INCLUDED
...
namespace ifc2x3
{
   ...
   public:
      ...
      IfcCurtainWallType(const IfcGloballyUniqueId& _GlobalId, IfcOwnerHistory* _OwnerHistory, const IfcCurtainWallTypeEnum& _PredefinedType)
         : IfcBuildingElementType(_GlobalId, _OwnerHistory), PredefinedType(_PredefinedType) {}

      virtual std::string name() const { return "IfcCurtainWallType"; }
   ...
   protected:
      virtual void serialize(ifc::StepWriter& w) const
      {
         ...
         w.writeAttributeValueEnumeration(IfcCurtainWallTypeEnumStringMap, PredefinedType);
         w.endEntity();
      }
