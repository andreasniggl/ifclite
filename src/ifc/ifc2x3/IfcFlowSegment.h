#ifndef IFC2X3_IFCFLOWSEGMENT_H_INCLUDED
#define IFC2X3_IFCFLOWSEGMENT_H_INCLUDED
...
namespace ifc2x3
{
   ...
   {
   public:
      virtual ~IfcFlowSegment(){}

      IfcFlowSegment() = default;

      IfcFlowSegment(const IfcGloballyUniqueId& _GlobalId, IfcOwnerHistory* _OwnerHistory)
         : IfcDistributionFlowElement(_GlobalId, _OwnerHistory) {}

      virtual std::string name() const { return "IfcFlowSegment"; }
