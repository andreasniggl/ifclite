...
namespace ifc4
{
   ...
   public:
      ...
      explicit IfcUShapeProfileDef(const IfcProfileTypeEnum& _ProfileType, const IfcPositiveLengthMeasure& _Depth, const IfcPositiveLengthMeasure& _FlangeWidth, const IfcPositiveLengthMeasure& _WebThickness, const IfcPositiveLengthMeasure& _FlangeThickness)
