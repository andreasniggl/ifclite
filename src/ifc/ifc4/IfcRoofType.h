...
namespace ifc4
{
   ...
   public:
      ...
      explicit IfcRoofType() = default;

      explicit IfcRoofType(const IfcGloballyUniqueId& _GlobalId, const IfcRoofTypeEnum& _PredefinedType)
         : IfcBuildingElementType(_GlobalId), PredefinedType(_PredefinedType) {}

      virtual std::string className() const { return "IfcRoofType"; }

      boost::optional<IfcRoofTypeEnum> PredefinedType; // required parameter
   ...
   protected:
      virtual void serialize(ifc::StepWriter& w) const
      {
         ...
         w.writeAttributeValue(IfcRoofTypeEnumStringMap, PredefinedType);
         w.endEntity();
      }
