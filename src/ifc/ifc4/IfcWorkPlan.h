...
namespace ifc4
{
   ...
   public:
      ...
      explicit IfcWorkPlan(const IfcGloballyUniqueId& _GlobalId, const IfcDateTime& _CreationDate, const IfcDateTime& _StartTime)
         : IfcWorkControl(_GlobalId, _CreationDate, _StartTime) {}

      virtual std::string className() const { return "IfcWorkPlan"; }

      boost::optional<IfcWorkPlanTypeEnum> PredefinedType; // optional parameter
   ...
   protected:
      virtual void serialize(ifc::StepWriter& w) const
      {
         ...
         w.writeAttributeValue(IfcWorkPlanTypeEnumStringMap, PredefinedType);
         w.endEntity();
      }
