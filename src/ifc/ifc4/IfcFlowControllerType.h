...
namespace ifc4
{
   ...
   public:
      ...
      explicit IfcFlowControllerType() = default;

      explicit IfcFlowControllerType(const IfcGloballyUniqueId& _GlobalId)
         : IfcDistributionFlowElementType(_GlobalId) {}

      virtual std::string className() const { return "IfcFlowControllerType"; }
