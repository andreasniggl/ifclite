...
namespace ifc4
{
   ...
   public:
      ...
      explicit IfcFlowMovingDeviceType() = default;

      explicit IfcFlowMovingDeviceType(const IfcGloballyUniqueId& _GlobalId)
         : IfcDistributionFlowElementType(_GlobalId) {}

      virtual std::string className() const { return "IfcFlowMovingDeviceType"; }
