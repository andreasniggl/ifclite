...
namespace ifc4
{
   ...
   public:
      ...
      explicit IfcPileType() = default;

      explicit IfcPileType(const IfcGloballyUniqueId& _GlobalId, const IfcPileTypeEnum& _PredefinedType)
         : IfcBuildingElementType(_GlobalId), PredefinedType(_PredefinedType) {}

      virtual std::string className() const { return "IfcPileType"; }
