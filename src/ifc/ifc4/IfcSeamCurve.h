...
namespace ifc4
{
   ...
   {
   public:
      virtual ~IfcSeamCurve(){}

      explicit IfcSeamCurve() = default;

      explicit IfcSeamCurve(IfcCurve* _Curve3D, const std::vector<IfcPcurve*>& _AssociatedGeometry, const IfcPreferredSurfaceCurveRepresentation& _MasterRepresentation)
         : IfcSurfaceCurve(_Curve3D, _AssociatedGeometry, _MasterRepresentation) {}

      virtual std::string className() const { return "IfcSeamCurve"; }
